...
/// The CrossContractCall contract implements the trait we defined earlier, and
/// fleshes out what the `inv_get` function should do with it arguments and how
/// it should create the value to return.
#[contractimpl]
