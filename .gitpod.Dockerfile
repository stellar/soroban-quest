...
RUN curl -L https://github.com/stellar/soroban-tools/releases/download/v0.9.4/soroban-cli-0.9.4-x86_64-unknown-linux-gnu.tar.gz | tar xz -C ~/.local/bin soroban
